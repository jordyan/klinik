...
<!--        <div id="header">
            <div id="menu" class="container">
                <ul>
                    ...
                    <li><a href="#" accesskey="1" title="">Registrasi</a></li>
                    <li><a href="#" accesskey="2" title="">Konsultasi</a></li>
...
<!--        <div id="logo" class="container">
        ...
        <div id="page" class="container">
            <div id="content">
                <div class="title">
                    <h2>Mental Capacity Development Center</h2>
                    <span class="byline">Klinik Taman Anggrek Jakarta</span>
                </div>
                <p>
                    Mental Capacity Development Center berlokasi di Klinik Taman Anggrek yang menghimpun para ahili di bidang "Mind Science" (dokter spesialis kedokteran jiwa dan perilaku, psikolog dan ahli pendidikan) untuk menerapkan ilmu tersebut bagi kemajuan masyarakat pada umumnya, dan khususnya dalam "Mental Capacity Development", sehingga masyarakat mampu menghadapi tantangan era informasi dan globalisasi ini dengan baik dan suskses.
                </p>
        ...
        <div id="copyright" class="container">
            <p>Copyright (c) 2015 Sitename.com. All rights reserved. </p>
        </div>
    </body>
</html>
